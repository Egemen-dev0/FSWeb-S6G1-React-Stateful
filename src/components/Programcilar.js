...
let [programciListesi, setprogramciListesi] = useState(enIyilerListesi);
let [programciId, setprogramciId] = useState(null);
...
if (programciId){
  const selectedProgrammer = programciListesi.find(dev => dev.id === programciId)

return selectedProgrammer ? selectedProgrammer.isim : "";
}
...
return ""
  ...
  const stil = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: programciId ? "goldenrod" : 'royalblue', // 🤔 kutlarken renk gold'a dönecek
  };
